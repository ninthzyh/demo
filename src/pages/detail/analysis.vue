  ...
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <v-counter @on-change="" @on-change="onParamChange('buyNum',$event)"></v-counter>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
...
import VMultiply from '../../components/multiply'
...
export default {
  ...
  methods:{
    ...
    getPrice(){
      let buyVersionArray=_.map(this.versions,
      (item)=>{
        return item.value
      })
      let reqParams={
   ...
   onChangeBanks(bankObj){
     this.banksId=bankObj.id
     console.log(this.banksId)
   },
   confirmBuy(){
     let buyVersionArray=_.map(this.versions,
      (item)=>{
